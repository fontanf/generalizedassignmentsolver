...
Instance generalizedassignmentsolver::test_instance(Counter i)
{
...
void generalizedassignmentsolver::test(InstacesType it, std::vector<Output (*)(Instance&)> fs, TestType tt)
{
    if (it == TEST) {
        TestInstances ti;
        test(ti, fs, tt);

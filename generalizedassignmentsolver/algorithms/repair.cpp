...
Output generalizedassignmentsolver::repairgreedy(const Instance& ins, Info info)
{
...
Output generalizedassignmentsolver::repaircombrelax(const Instance& ins, Info info)
{
    Output output(ins, info);
    ItemIdx n = ins.item_number();
...
Output generalizedassignmentsolver::repairlinrelax_clp(const Instance& ins, const LinRelaxClpOutput& linrelax_output, Info info)
{
    Output output(ins, info);
    AgentIdx m = ins.agent_number();
    ItemIdx n = ins.item_number();
